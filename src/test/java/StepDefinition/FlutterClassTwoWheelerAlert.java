...
public class FlutterClassTwoWheelerAlert {
	static String serialno = "EAB3244W000"+RandomStringUtils.randomNumeric(3);
	static String alerttext ="Please use customer Mobile No/ email for Registration. You can’t use the same email/Mobile No in more than 10 Transactions.?";
	 static AndroidDriver driver = null;
	 static CustomerTwoWheelerRegistrationPage cmp = new CustomerTwoWheelerRegistrationPage(driver);
...
//		    diesel.click();
		...
		//    Thread.sleep(3000);
		  ...
		  //  Thread.sleep(2000);
		    ...
		    String ExpectedalertText = cmp.alertTextVerification();
		    if(ExpectedalertText.equalsIgnoreCase(ExpectedalertText))
		    {
